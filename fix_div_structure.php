...
// Fix the extra closing div and missing right panel
// The problem is located around here:
// </div> <!-- This is the original closing div for form-container -->
// <!-- Footer Buttons -->
// <div class="...">...</div>
// </div>
// </div>
...
// Let's just fix it by replacing the whole structure:
$regex = '/<\/div>\s*<!-- Footer Buttons -->\s*<div class="mt-8 pt-6 pb-12 border-t border-gray-200 flex justify-between">.*?<\/div>\s*<\/div>\s*<\/div>\s*<!-- Right Panel: Realtime Preview -->/s';

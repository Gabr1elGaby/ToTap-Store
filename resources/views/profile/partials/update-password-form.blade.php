    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-5">
        ...
        <div>
            ...
            <input id="update_password_current_password" 
                   ...
                   type="password" 
                   class="block w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl text-sm font-semibold text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition shadow-sm" 

            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" 
                ...
                <div class="text-center max-w-4xl mx-auto">
                    ...
                    <div class="flex justify-center items-center gap-4">
                        ...
                        @else
                            <a href="/register" @click.prevent="showRegister = true" class="px-8 py-3 bg-white dark:bg-transparent text-gray-800 dark:text-white border border-gray-300 dark:border-gray-600 rounded-xl font-bold text-sm uppercase tracking-wider hover:bg-gray-100 dark:hover:bg-gray-800 transition shadow-sm">
                                Daftar Sekarang
                            </a>
                        @endauth
                    </div>
                ...
                <div class="flex flex-wrap justify-center items-center gap-8">
                    ...
                    <a href="/software" 
                       ...
                       data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <!-- Icon -->
                        <div class="relative flex items-center justify-center mb-2 group-hover:-translate-y-2 transition-transform duration-300" style="width: 130px; height: 130px;">
                            <img src="{{ asset('images/software-logo.png') }}" alt="Software" class="w-24 h-24 object-contain" style="filter: drop-shadow(0px 8px 10px rgba(0,0,0,0.1));">
                        </div>

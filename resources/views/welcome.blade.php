...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@700;900&display=swap" rel="stylesheet">
        ...
        <title>ToTap Store - Enterprise Software Solutions</title>
...
<style>
    ...
    <body class="antialiased text-white bg-gray-900" x-data="{ showLogin: false, showRegister: false }" @open-login.window="showLogin = true" @open-register.window="showRegister = true" :class="{ 'overflow-hidden': showLogin || showRegister }">
        ...
        <!-- Hero Section -->
        <section class="relative bg-gray-900 border-b border-gray-800 pt-20 pb-24 overflow-hidden" id="beranda" 
            x-data="{ scrollY: 0 }" 
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" 
                ...
                <div class="text-center max-w-4xl mx-auto">
                    ...
                    <p class="text-lg text-gray-400 mb-10 leading-relaxed max-w-2xl mx-auto">
                        ...
                        @auth
                            <a href="/profile" class="px-8 py-3 bg-transparent text-white border border-gray-600 rounded font-bold text-sm uppercase tracking-wider hover:bg-gray-800 transition">
                                Profil Saya
                            </a>
                        @else
...
<section id="keunggulan" class="py-20 bg-gray-800 border-b border-gray-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div class="p-6 border border-gray-700 rounded hover:border-blue-500 transition shadow-sm bg-gray-800" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <h4 class="text-xl font-bold text-white mb-3">Proses Instan 24/7</h4>
                    ...
                    <div class="p-6 border border-gray-700 rounded hover:border-blue-500 transition shadow-sm bg-gray-800" data-aos="fade-up" data-aos-delay="100">
                        <div class="w-12 h-12 bg-gray-900 rounded flex items-center justify-center text-white mb-6">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                        </div>
                        <h4 class="text-xl font-bold text-white mb-3">Aman & Terpercaya</h4>
                    ...
                    <div class="p-6 border border-gray-700 rounded hover:border-blue-500 transition shadow-sm bg-gray-800" data-aos="fade-up" data-aos-delay="200">
                        <div class="w-12 h-12 bg-gray-900 rounded flex items-center justify-center text-white mb-6">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        </div>
                        <h4 class="text-xl font-bold text-white mb-3">Harga Termurah</h4>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                    ...
                    <div class="relative text-center" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <h4 class="text-xl font-bold text-white mb-3"><span class="text-blue-500 mr-2">1.</span>Buat Akun</h4>
                        <p class="text-gray-400 text-base leading-relaxed">Daftar dan buat akun ToTap Store Anda secara gratis untuk mempermudah transaksi.</p>
                    </div>
                    ...
                    <div class="relative text-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h4 class="text-xl font-bold text-white mb-3"><span class="text-blue-500 mr-2">2.</span>Pilih Kategori</h4>
                        <p class="text-gray-400 text-base leading-relaxed">Pilih layanan yang Anda butuhkan: Top Up Game instant atau lisensi Software bisnis.</p>
                    </div>
                    ...
                    <div class="relative text-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h4 class="text-xl font-bold text-white mb-3"><span class="text-blue-500 mr-2">3.</span>Pembayaran</h4>
                        <p class="text-gray-400 text-base leading-relaxed">Selesaikan pesanan Anda menggunakan metode pembayaran terenkripsi yang aman & otomatis.</p>
                    </div>
                    ...
                    <div class="relative text-center" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <h4 class="text-xl font-bold text-white mb-3"><span class="text-blue-500 mr-2">4.</span>Selesai</h4>
                        <p class="text-gray-400 text-base leading-relaxed">Layanan langsung aktif dan pesanan otomatis masuk ke akun Anda dalam hitungan detik!</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="kategori" class="py-16 bg-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                
                <div class="mb-10 text-center" data-aos="fade-up">
                    <h2 class="text-3xl font-extrabold text-white tracking-tight">Pilih Kategori</h2>
                    <p class="mt-2 text-base text-gray-400 max-w-2xl mx-auto">Silakan pilih layanan yang Anda butuhkan di bawah ini.</p>
                </div>
                ...
                <div class="flex flex-wrap justify-center items-center gap-8">
                    ...
                    <a href="{{ route('topup.index') }}" 
                       class="relative shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center justify-center group border border-gray-700 category-card-glow" 
                    ...
                    <a href="/software" 
                       ...
                       data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <!-- Icon -->
                        <div class="relative flex items-center justify-center mb-2 group-hover:-translate-y-2 transition-transform duration-300" style="width: 130px; height: 130px;">
                            <img src="{{ asset('images/software-logo.png') }}" alt="Software" class="w-24 h-24 object-contain" style="filter: drop-shadow(0px 8px 10px rgba(0,0,0,0.3));">
                        </div>

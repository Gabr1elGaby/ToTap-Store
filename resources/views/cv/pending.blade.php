...
<body class="bg-gray-50 text-gray-900 font-sans antialiased flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full bg-white rounded-xl shadow-xl overflow-hidden p-8 text-center border border-gray-100">

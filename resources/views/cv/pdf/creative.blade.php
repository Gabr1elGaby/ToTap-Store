...
<head>
    <meta charset="utf-8">
    <title>{{ $template->name ?? "Kreatif & Desain Visual Indonesia" }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 0;
    ...
    <div class="full-page-container">
        <table class="full-page-header">
            <tr>
                ...
                <td style="text-align: right; font-size: 7pt; font-weight: bold; color: #ec4899; text-transform: uppercase;">

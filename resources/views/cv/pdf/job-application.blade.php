...
<head>
    <meta charset="utf-8">
    <title>{{ $template->name ?? "Lamaran Kerja Formal CPNS & BUMN" }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 0;
    ...
    <div class="full-page-container">
        <table class="full-page-header">
            <tr>
                ...
                <td style="text-align: right; font-size: 7pt; font-weight: bold; color: #0284c7; text-transform: uppercase;">

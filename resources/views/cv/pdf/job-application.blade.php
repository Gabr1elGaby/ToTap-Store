...
<head>
    <meta charset="utf-8">
    <title>{{ $template->name ?? "Lamaran Kerja Profesional" }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 0;
        ...
        * {
        ...
        .sidebar-heading {
            ...
            color: #6ee7b7;
            border-bottom: 1pt solid #1e3a2b;
            padding-bottom: 2pt;
            margin-top: 6pt;
            margin-bottom: 3.5pt;
        }
        ...
        <tr>
            ...
            <td class="content-td">
                ...
                @foreach($projects as $proj)
                    ...
                    @if(!empty($pName))
                    <div class="item-block">
                        <div class="item-title">{{ $pName }} @if($pLink)<span style="font-weight: normal; font-size: 6.5pt; color: #047857;">({{ $pLink }})</span>@endif</div>

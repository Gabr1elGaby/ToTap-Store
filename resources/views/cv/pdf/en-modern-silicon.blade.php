...
<head>
    <meta charset="utf-8">
    <title>{{ $template->name ?? "Silicon Valley Modern Tech" }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 0;
...
<body>
    ...
    <table class="page1-table">
        <tr>
            ...
            <td class="sidebar-td">
                ...
                <div class="side-heading" style="margin-top: 0;">Contact Information</div>
                ...
                <div class="side-heading">Skills & Tools</div>
                ...
                <div class="side-heading">Certifications & Licenses</div>
            ...
            <!-- MAIN CONTENT -->
            <td class="main-td">
                <div class="header-name">{{ $getVal($data, "name") ?: "FULL NAME" }}</div>
                <div class="header-title">{{ $getVal($data, "job_title") ?: "PROFESSIONAL TITLE" }}</div>

                @if($getVal($data, "profile", "summary") !== "")
                <div class="main-heading" style="margin-top: 0;">Professional Summary</div>
    ...
    <div class="full-page-container">
        <table class="full-page-header">
            <tr>
                <td style="font-size: 10pt; font-weight: 900; color: #0f172a; text-transform: uppercase;">
                    {{ $getVal($data, "name") ?: "FULL NAME" }}
                </td>
                <td style="text-align: right; font-size: 7pt; font-weight: bold; color: #2563eb; text-transform: uppercase;">
                    {{ $getVal($data, "job_title") ?: "PROFESSIONAL TITLE" }}
                </td>
            </tr>
        </table>
        ...
        <div class="main-heading" style="margin-top: 0;">Work Experience (Lanjutan)</div>
        ...
        <div class="main-heading">Key Projects & Portfolio</div>
        ...
        <div class="main-heading">Internships & Practical Training</div>
        ...
        <div class="main-heading">Leadership & Organizations</div>

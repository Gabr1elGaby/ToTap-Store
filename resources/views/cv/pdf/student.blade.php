...
<head>
    <meta charset="utf-8">
    <title>{{ $template->name ?? "Mahasiswa & Magang" }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 0;
        ...
        * {
        ...
        .sidebar-heading {
            ...
            color: #c7d2fe;
            border-bottom: 1pt solid #3730a3;
            padding-bottom: 2pt;
            margin-top: 6pt;
            margin-bottom: 3.5pt;
        }
    ...
    <table class="cv-table" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="content-td" style="padding-top: 18pt;">
                ...
                <div class="right-heading" style="margin-top: 4pt;">Pengalaman Kerja</div>
        ...
        <tr>
            ...
            <td class="content-td">
                ...
                <div class="right-heading" style="margin-top: 0;">Riwayat Pendidikan</div>
        ...
        <tr>
            ...
            <td class="content-td">
                ...
                @foreach($projects as $proj)
                    ...
                    @if(!empty($pName))
                    <div class="item-block">
                        <div class="item-title">{{ $pName }} @if($pLink)<span style="font-weight: normal; font-size: 6.5pt; color: #4338ca;">({{ $pLink }})</span>@endif</div>

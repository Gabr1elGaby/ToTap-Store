...
<head>
    <meta charset="utf-8">
    <title>{{ $template->name ?? "Academic & Research CV" }}</title>
    <style>
        @page {
            size: A4;
            margin: 0;
            ...
            <tr>
                ...
                <td class="content-td">
                    ...
                    @foreach($projects as $proj)
                        ...
                        @if(!empty($pName))
                        <div class="item-block">
                            <div class="item-title">{{ $pName }} @if($pLink)<span style="font-weight: normal; font-size: 6.5pt; color: #2563eb;">({{ $pLink }})</span>@endif</div>

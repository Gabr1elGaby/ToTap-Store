...
<body>
    ...
    <div class="sidebar-bg" style="position: absolute; top: 0; left: 0; width: 32%; height: 842pt; background-color: #064e3b; z-index: -10;"></div>
                    ...
                    @foreach($skills as $skill)
                        ...
                        <div style="margin-bottom: 5pt; width: 100%;">
                            <table style="width: 100%; margin-bottom: 1.5pt; border-collapse: collapse;">
                                <tr>
                                    <td style="font-size: 7.5pt; font-weight: bold; color: #f0fdf4; text-align: left; vertical-align: middle; padding: 0;">
                                        {{ $sName }}
                                    </td>
                                    <td style="font-size: 7pt; font-weight: bold; color: #34d399; text-align: right; width: 28pt; vertical-align: middle; padding: 0;">
                                        {{ $lvl }}%
                                    </td>
                                </tr>
                            </table>
                            <div style="width: 100%; height: 3.5pt; background-color: #065f46; border-radius: 2pt; overflow: hidden;">
                                <div style="width: {{ $lvl }}%; height: 3.5pt; background-color: #34d399; border-radius: 2pt;"></div>
                            </div>
                        </div>
                        @else
                        <div style="margin-bottom: 3pt; font-size: 7.5pt; color: #f0fdf4; line-height: 1.25;">
                            <span style="color: #34d399; font-weight: bold;">•</span> {{ $sName }}
                        </div>
                        @endif
                    @endforeach
                </div>

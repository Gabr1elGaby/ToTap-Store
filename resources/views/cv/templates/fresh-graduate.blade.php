    ...
    <table class="page1-layout" cellpadding="0" cellspacing="0">
        <tr>
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 16pt;">
                    <?php if(!empty($data->photo)): ?>
                        <img src="<?php echo $data->photo; ?>" style="width: 75pt; height: 75pt; border-radius: 50%; border: 3pt solid #D4AF37; display: block; margin: 0 auto; object-fit: cover;">
                    <?php else: ?>
                ...
                <div class="contact-item">
                    ...
                    <span class="contact-value"><?php echo $data->phone; ?></span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data->email)): ?>
                <div class="contact-item">
                    <span class="contact-label">Email</span>
                    <span class="contact-value"><?php echo $data->email; ?></span>
                </div>
                <?php endif; ?>
                <?php if($getVal($data, "address", "location") !== ""): ?>
                <div class="contact-item">
                    <span class="contact-label">Domisili</span>
                    <span class="contact-value"><?php echo $getVal($data, "address", "location"); ?></span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data->linkedin)): ?>
                <div class="contact-item">
                    <span class="contact-label">LinkedIn</span>
                    <span class="contact-value"><?php echo $data->linkedin; ?></span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data->website)): ?>
                <div class="contact-item">
                    <span class="contact-label">Website</span>
                    <span class="contact-value"><?php echo $data->website; ?></span>
                </div>
                <?php endif; ?>
                ...
                <div style="margin-bottom: 8pt;">
                    ...
                    <div style="font-size: 7.5pt; color: #D4AF37;"><?php echo $cert->year; ?></div>
                    <?php endif; ?>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
            ...
            <td class="content-td">
                ...
                <div class="job-title"><?php echo !empty($data->job_title) ? $data->job_title : "Lulusan Baru / Fresh Graduate"; ?></div>

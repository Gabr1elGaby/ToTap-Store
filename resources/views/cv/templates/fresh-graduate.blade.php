            ...
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 12pt;">
                    <?php if(!empty($data->photo)): ?>
                        <img src="<?php echo $data->photo; ?>" style="width: 60pt; height: 60pt; border-radius: 50%; border: 2.5pt solid #D4AF37; display: block; margin: 0 auto; object-fit: cover;">
                    <?php else: ?>
                        <div style="width: 60pt; height: 60pt; border-radius: 50%; border: 2.5pt solid #D4AF37; background-color: rgba(255,255,255,0.08); margin: 0 auto; text-align: center; line-height: 60pt; font-size: 18pt; font-weight: bold; color: #D4AF37;">
                            <?php echo $initials; ?>
                        </div>
                    <?php endif; ?>
                </div>

...
<body>
    ...
    <div style="position: fixed; top: 0px; left: 0px; width: 185pt; height: 100%; background-color: #1e1b4b; z-index: -100;"></div>

    <!-- LEFT SIDEBAR -->
    <div class="sidebar">
        <div style="text-align: center; margin-bottom: 14pt;">
            <?php if(!empty($data->photo)): ?>
                <img src="<?php echo $data->photo; ?>" style="width: 65pt; height: 65pt; border-radius: 50%; border: 3pt solid #6366f1; display: block; margin: 0 auto; object-fit: cover;">
            <?php else: ?>
                <div style="width: 65pt; height: 65pt; border-radius: 50%; border: 3pt solid #6366f1; background-color: rgba(255,255,255,0.08); margin: 0 auto; text-align: center; line-height: 65pt; font-size: 20pt; font-weight: bold; color: #6366f1;">
                    <?php echo $initials; ?>
                </div>
            <?php endif; ?>
        </div>

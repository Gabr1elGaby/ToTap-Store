            ...
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 14pt;">
                    <?php if(!empty($data->photo)): ?>
                        <img src="<?php echo $data->photo; ?>" style="width: 65pt; height: 65pt; border-radius: 50%; border: 2.5pt solid #6366f1; display: block; margin: 0 auto; object-fit: cover;">
                    <?php else: ?>
                        <div style="width: 65pt; height: 65pt; border-radius: 50%; border: 2.5pt solid #6366f1; background-color: rgba(255,255,255,0.08); margin: 0 auto; text-align: center; line-height: 65pt; font-size: 20pt; font-weight: bold; color: #6366f1;">
                            <?php echo $initials; ?>
                        </div>
                    <?php endif; ?>
                </div>

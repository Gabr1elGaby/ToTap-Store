    ...
    <style>
        ...
        * {
        ...
        .sidebar-heading {
            ...
            letter-spacing: 1px;
            color: #fecdd3;
            border-bottom: 1pt solid #6b21a8;
            padding-bottom: 2pt;
            margin-top: 10pt;
            margin-bottom: 6pt;
        }
...
<body>
    ...
    <div class="sidebar-bg" style="position: absolute; top: 0; left: 0; width: 32%; height: 842pt; background-color: #4c1d95; z-index: -10;"></div>
                    ...
                    @foreach($skills as $skill)
                        ...
                        <div style="margin-bottom: 5pt; width: 100%;">
                            <table style="width: 100%; margin-bottom: 1.5pt; border-collapse: collapse;">
                                <tr>
                                    <td style="font-size: 7.5pt; font-weight: bold; color: #faf5ff; text-align: left; vertical-align: middle; padding: 0;">
                                        {{ $sName }}
                                    </td>
                                    <td style="font-size: 7pt; font-weight: bold; color: #fb7185; text-align: right; width: 28pt; vertical-align: middle; padding: 0;">
                                        {{ $lvl }}%
                                    </td>
                                </tr>
                            </table>
                            <div style="width: 100%; height: 3.5pt; background-color: #581c87; border-radius: 2pt; overflow: hidden;">
                                <div style="width: {{ $lvl }}%; height: 3.5pt; background-color: #f43f5e; border-radius: 2pt;"></div>
                            </div>
                        </div>
                        @else
                        <div style="margin-bottom: 3pt; font-size: 7.5pt; color: #faf5ff; line-height: 1.25;">
                            <span style="color: #fb7185; font-weight: bold;">•</span> {{ $sName }}
                        </div>
                        @endif
                    @endforeach
                </div>

    ...
    <table class="main-layout" cellpadding="0" cellspacing="0">
        <tr>
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 16pt;">
                    <?php if(!empty($data->photo)): ?>
                        <img src="<?php echo $data->photo; ?>" style="width: 75pt; height: 75pt; border-radius: 50%; border: 3pt solid #fbcfe8; display: block; margin: 0 auto; object-fit: cover;">
                    <?php else: ?>
                ...
                <div style="margin-bottom: 8pt;">
                    ...
                    <div style="font-size: 7.5pt; color: #fbcfe8;"><?php echo $cert->year; ?></div>
                    <?php endif; ?>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
            ...
            <td class="content-td">
                ...
                <div class="job-title"><?php echo !empty($data->job_title) ? $data->job_title : "Mahasiswa / Pelajar Aktif"; ?></div>

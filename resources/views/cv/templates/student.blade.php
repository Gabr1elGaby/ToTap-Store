...
<head>
    <meta charset="utf-8">
    <title>CV Mahasiswa / Pelajar</title>
    <style>
        @page {
            margin: 0px;
            size: a4 portrait;
...
<body>
    ...
    <div style="position: absolute; top: 0px; left: 0px; width: 32%; height: 842pt; background-color: #312e81; z-index: -100;"></div>
        ...
        <tr>
            ...
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 16pt;">
                    @if(!empty($data->photo))
                        <img src="{{ $data->photo }}" style="width: 75pt; height: 75pt; border-radius: 50%; border: 3pt solid #fbcfe8; display: block; margin: 0 auto; object-fit: cover;">
                    @else
                        <div style="width: 75pt; height: 75pt; border-radius: 50%; border: 3pt solid #fbcfe8; background-color: #701a75; margin: 0 auto; text-align: center; line-height: 75pt; font-size: 22pt; font-weight: bold; color: #fbcfe8;">
                            {{ $initials }}
                        </div>
                    @endif
                </div>
                        ...
                        <div style="margin-bottom: 7pt; width: 100%;">
                            <table style="width: 100%; margin-bottom: 2pt; border-collapse: collapse;">
                                <tr>
                                    ...
                                    <td style="font-size: 7.5pt; font-weight: bold; color: #fbcfe8; text-align: right; width: 35pt; vertical-align: middle;">
                                        {{ $lvl }}%
                                    </td>
                                </tr>
                            </table>
                            <div style="width: 100%; height: 4pt; background-color: #4338ca; border-radius: 2pt; overflow: hidden;">
                                <div style="width: {{ $lvl }}%; height: 4pt; background-color: #f472b6; border-radius: 2pt;"></div>
                            </div>
                        </div>
                        @else
                        <div style="margin-bottom: 4pt; font-size: 8.5pt; color: #fdf2f8;">
                            <span style="color: #fbcfe8; font-weight: bold;">•</span> {{ $skill->name ?? '' }}
                        </div>
                        @endif
                    @endforeach
                </div>
                ...
                <div class="left-header">Prestasi & Sertifikat</div>
                @foreach($certificates as $cert)
                <div style="margin-bottom: 8pt;">
                    <div style="font-weight: bold; color: #ffffff; font-size: 8.5pt;">{{ $cert->name ?? '' }}</div>
                    @if(!empty($cert->year))
                    <div style="font-size: 7.5pt; color: #fbcfe8;">{{ $cert->year }}</div>
                    @endif
                </div>
                @endforeach
                @endif
            ...
            <td class="content-td">
                ...
                <div class="job-title">{{ !empty($data->job_title) ? $data->job_title : 'Mahasiswa / Pelajar Aktif' }}</div>
                
                @if(!empty($data->profile))
                <div class="right-header">Ringkasan Profil</div>
                ...
                <div class="right-header">Pengalaman Kerja / Part-Time</div>

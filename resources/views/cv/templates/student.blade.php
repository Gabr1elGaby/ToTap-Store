            ...
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 12pt;">
                    <?php if(!empty($data->photo)): ?>
                        <img src="<?php echo $data->photo; ?>" style="width: 55pt; height: 55pt; border-radius: 50%; border: 2pt solid #be185d; display: block; margin: 0 auto; object-fit: cover;">
                    <?php else: ?>
                        <div style="width: 55pt; height: 55pt; border-radius: 50%; border: 2pt solid #be185d; background-color: rgba(255,255,255,0.08); margin: 0 auto; text-align: center; line-height: 55pt; font-size: 18pt; font-weight: bold; color: #be185d;">
                            <?php echo $initials; ?>
                        </div>
                    <?php endif; ?>
                </div>

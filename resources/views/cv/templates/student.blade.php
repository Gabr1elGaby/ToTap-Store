        ...
        <tr>
            <td class="sidebar-td">
                <div style="text-align: center; margin-bottom: 16pt;">
                    ...
                    <?php else: ?>
                        <div style="width: 75pt; height: 75pt; border-radius: 50%; border: 3pt solid #fbcfe8; background-color: #1e293b; margin: 0 auto; text-align: center; line-height: 75pt; font-size: 22pt; font-weight: bold; color: #fbcfe8;">
                            <?php echo $initials; ?>
                        </div>
                    <?php endif; ?>
                </div>

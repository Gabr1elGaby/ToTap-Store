...
$newLogic = <<<BLADE
                    ...
                    <a href="{{ route('topup.index') }}" 
                       ...
                       data-aos="zoom-in">
                        ...
                        <!-- Icon -->
                        <div class="relative flex items-center justify-center mb-0 group-hover:-translate-y-2 transition-transform duration-300" style="width: 150px; height: 150px;">
BLADE;

$content = str_replace($oldLogic, $newLogic, $content);
file_put_contents($file, $content);
echo "Card size reverted, logo kept large.\n";

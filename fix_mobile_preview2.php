...
$content = preg_replace(
    '/<nav class="bg-white border-b border-gray-200 shrink-0 shadow-sm z-10 relative">.*?<\/nav>/s',
...
$content = preg_replace('/<!-- Right Panel: Preview \(Desktop Only\) -->/', $mobile_btn . "\n        <!-- Right Panel: Preview (Desktop Only) -->", $content, 1);

// Modify Right Panel classes
$content = preg_replace(

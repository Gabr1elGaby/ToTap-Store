...
// Find the footer div
$footer_regex = '/\s*<!-- Footer Buttons -->\s*<div class="px-6 py-4 border-t border-gray-200 bg-white shrink-0 flex justify-between">.*?<\/div>\s*<\/div>\s*<!-- Right Panel: Realtime Preview -->/s';
...
$content = preg_replace($footer_regex, $replacement, $content);

file_put_contents($file, $content);
echo "Done with regex replacement.\n";

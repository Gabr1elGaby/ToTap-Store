...
// Use regex to replace the entire keunggulan section
$content = preg_replace('/<section id="keunggulan".*?<\/section>\s*<!-- Kategori Utama Section -->/s', $newSection . "\n\n        <!-- Kategori Utama Section -->", $content);

file_put_contents($welcomeFile, $content);
echo "Replaced entire keunggulan section.\n";

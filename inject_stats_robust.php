...
// Inject right before <section id="keunggulan"
if (strpos($content, '<!-- Stats Section -->') === false) {
    $content = str_replace('<section id="keunggulan"', $statsSection . "\n\n<section id=\"keunggulan\"", $content);
    file_put_contents($welcomeFile, $content);
    echo "Stats section successfully injected.\n";
} else {
    echo "Stats section already exists.\n";
}
